<template>
  <div class="container">
    <h2>Markdown Demo</h2>
    <Editor :value="markdownContent" :handleChange="handleChange" />
    <Viewer />
  </div>
...
import { ref } from 'vue'
import Editor from '../components/MdEditor.vue' // 假设 Editor 组件放在 components 目录下
import Viewer from '../components/MdViewer.vue' // 假设 Viewer 组件放在 components 目录下
